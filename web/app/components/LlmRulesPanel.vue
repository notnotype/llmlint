...
import {ref} from "vue";
import type {LLMRuleRecord} from "../types";
import {useLlmlintI18n} from "../composables/useLlmlintI18n";

// 只读折叠面板：本页（纯 regex）不检测、需 Agent 语义判断的规则
defineProps<{rules: LLMRuleRecord[]}>();
