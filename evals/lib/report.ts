...
export function buildReport(corpusRoot: string, metrics: Metrics, activeRegexRules: number, minSupport: number, warnings: string[], renderPromptVersion: string | null): Report {
